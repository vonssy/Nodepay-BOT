            ...
            if result and isinstance(result, dict):
                ...
                if ip_score is not None:
                    self.log(
                        ...
                        f"{Fore.MAGENTA + Style.BRIGHT}] [ Ip Score{Style.RESET_ALL}"
                ...
                self.log(
                    ...
                    f"{Fore.WHITE + Style.BRIGHT} With Proxy {proxy} {Style.RESET_ALL}"
                    f"{Fore.MAGENTA + Style.BRIGHT}-{Style.RESET_ALL}"
                    f"{Fore.BLUE + Style.BRIGHT} Try Next Proxy... {Style.RESET_ALL}"
                    f"{Fore.MAGENTA + Style.BRIGHT}]{Style.RESET_ALL}"
                )
                ...
                if not proxy:
                    self.log(
                        f"{Fore.MAGENTA + Style.BRIGHT}[ Account{Style.RESET_ALL}"
                        f"{Fore.WHITE + Style.BRIGHT} {username} {Style.RESET_ALL}"
                        f"{Fore.RED + Style.BRIGHT}No Proxies Found{Style.RESET_ALL}"
                        f"{Fore.MAGENTA + Style.BRIGHT} ]{Style.RESET_ALL}"
                    )
                    break
